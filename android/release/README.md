...
- `multi-agent-shognate-installer-<tag>.bat` (Windows bootstrap installer for the same release tag)
- `multi-agent-shognate-updater-<tag>.bat` (Windows updater that moves an installed portable copy to the latest Release)
