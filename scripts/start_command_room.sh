...
usage() {
  cat << 'USAGE'
Usage:
  bash scripts/start_command_room.sh [options] [-- <shutsujin_departure.sh options>]
...
Examples:
  bash scripts/start_command_room.sh
  bash scripts/start_command_room.sh -s
  bash scripts/start_command_room.sh -- --shogun-no-thinking
USAGE
}
