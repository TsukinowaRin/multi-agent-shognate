...
2. Re-read your instructions file (`instructions/shogun.md`, `instructions/gunkan.md`, `instructions/karo.md`, `instructions/ashigaru.md`, `instructions/gunshi.md` as applicable).
