...
mode: primary
# Auto-generated by build_instructions.sh — do not edit manually.
# Source: shogunate_mod/instructions/source/roles/${role}_role.md + shogunate_mod/instructions/source/common/* + shogunate_mod/instructions/source/cli_specific/opencode_tools.md
