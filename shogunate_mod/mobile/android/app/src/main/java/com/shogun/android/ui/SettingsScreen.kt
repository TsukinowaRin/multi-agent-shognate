...
private fun ManualConnectionSettings(
    ...
    Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
        ...
        OutlinedTextField(
            ...
            supportingText = { Text("Pair後は project 専用 target が入ります。例: shogunate-app-1234:goza.0") },
            modifier = Modifier.fillMaxWidth(),
            singleLine = true
        )
        ...
        OutlinedTextField(
            ...
            supportingText = { Text("Pair後は project 専用 target が入ります。例: shogunate-app-1234:goza") },
            modifier = Modifier.fillMaxWidth(),
            singleLine = true
        )
    }
